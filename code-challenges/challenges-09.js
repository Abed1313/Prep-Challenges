...
const roundDecimals = (arr) => {
    let ab=[5.4, 5.5 ,6.7, 6.8];
let cc=[];
for(let i=0;i<ab.length;i++){
cc.push(Math.round(ab[i]));
} 
console.log(cc);
}
// -------------------------------------------------------------------------------------------------------
...
const employeesBonus = (arr) => {
    let newData=[];
    arr.forEach(resultt =>{
  if(resultt.workHours >8){
    resultt.salary=(parseFloat(resultt.salary)+100)+"$";
    }if(resultt.workHours<=8){
      resultt.salary=(parseFloat(resultt.salary)+50)+"$";
    }
    newData.push(resultt);
});
console.log(newData);
}
// -------------------------------------------------------------------------------------------------------

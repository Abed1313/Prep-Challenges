...
function gradesAvg(arr) {
  return arr.map(student => {
      let sum = student.gradsList.reduce((acc, grade) => acc + grade, 0);      // Calculate the sum of the grades
      let avg = sum / student.gradsList.length;                                // Calculate the average of the grades
                                           // Return a new object including the original student properties and the new avg property
      return {
          ...student,
          avg: avg
      };
